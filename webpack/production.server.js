...
// console.log(path.resolve(__dirname, '..', config[NODE_ENV].assets_path.react, '..', 'bundle.js'))
// console.log(path.resolve('..', config[NODE_ENV].assets_path.react, 'App.js'))
let app = [
    'App.js',
    'server.js',
    'routes.js',
...
/* .local.scss */
let scssLocalUse = [
    'css-loader/locals?modules&importLoaders=1&minimize&localIdentName=[hash]',
    {
        ...
        rules: [
            ...
            /* .scss */
            {
                resource: {
                    ...
                    // exclude: '',
                    include: [
                        path.resolve(__dirname, '..', 'src/sass'), // !!!!!!!!! ПИЗДЕЙ КАК ВАЖНО УКАЗАТЬ !!!!!!!!!!!!!!!!!
                    ],
                },
                use: scssUse
            },
